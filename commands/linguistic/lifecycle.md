...
routes_to: magic-linguistic-orchestrator
---

# /linguistic:lifecycle

Activate the `magic-linguistic-orchestrator` skill and enter the 5-phase pipeline. The orchestrator will:

1. Read or create `workspace_state.md` for the current cwd.
2. Identify the target language(s) and resource class via `magic-linguistic-scope`.
