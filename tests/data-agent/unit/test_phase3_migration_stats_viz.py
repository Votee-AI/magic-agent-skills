...
# Paths
# ---------------------------------------------------------------------------
VIZ_DIR   = Path(__file__).resolve().parents[3] / "skills" / "magic-data-visualization" / "scripts"
STATS_DIR = Path(__file__).resolve().parents[3] / "skills" / "magic-statistical-analysis" / "scripts"
