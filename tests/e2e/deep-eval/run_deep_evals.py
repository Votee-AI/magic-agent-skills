...
def d5_00_dd_validate(datasets_dir: Path) -> ScenarioResult:
    ...
    try:
        ...
        dd_bin = Path(__file__).parent.parent.parent.parent / "workspace" / ".venv" / "bin" / "data-designer"
...
FIXTURE_DB = Path(__file__).parent.parent.parent / "fixtures" / "test_database.sqlite"
