# Skill Evaluation Report: magic-linguistic-semantics (iteration 2 — LIVE)
...
| **Anti-patterns** | ~22% | 7 NEVERs in SKILL L92-100; 4 NEVERs in mwe_parseme.md L72-75; 3 NEVERs in framenet_srl.md L60-62; mirrored anti_patterns array in srl_frame_advisor.py L82-86; concrete worked anti-example "kick the bucket as 3 unrelated content words" L99; "NEVER report semantic-equivalence with BLEU" L97 (cross-references magic-linguistic-eval); "Building MWE catalog without native-speaker review" (mwe_parseme.md L74) |
...
```
$ python3 skills/magic-linguistic-semantics/scripts/wordnet_coverage.py Yoruba
...
$ python3 skills/magic-linguistic-semantics/scripts/wordnet_coverage.py English
...
$ python3 skills/magic-linguistic-semantics/scripts/srl_frame_advisor.py Spanish
...
$ python3 skills/magic-linguistic-semantics/scripts/srl_frame_advisor.py Yoruba
...
**Comparative framing:** at iter-2-live, magic-linguistic-semantics (102) ties with magic-linguistic-bitext (102), magic-linguistic-morph (102), and magic-linguistic-syntax (102) — a tight A- cluster sitting one or two points behind ethics (106), scope (105), transfer (105), and the simulated-but-not-yet-relived magic-linguistic-eval (108). The simulated 101 is honestly priced; Phase-1 ship target met.
