# Skill Evaluation Report: linguistic-speech (iteration 2 — LIVE)
...
```
$ python3 skills/linguistic-speech/scripts/lhotse_recipe_advisor.py Yoruba --input-format elan_eaf --joshi-class 1 --audio-hours 0.5
...
$ python3 skills/linguistic-speech/scripts/lhotse_recipe_advisor.py Cherokee --input-format flex_xml --joshi-class 0 --audio-hours 0.5
...
$ python3 skills/linguistic-speech/scripts/lhotse_recipe_advisor.py Vietnamese --input-format praat_textgrid --joshi-class 3
→ asr.primary: "Whisper-large fine-tune OR MMS"
→ tone_language: true
→ anti_patterns: 1 emitted (tone strip)
→ exit code 0

$ python3 skills/linguistic-speech/scripts/ipa_validate.py Mandarin "mā"
→ valid: true, tone_marks_present: true, invalid_characters: []
→ exit code 0

$ python3 skills/linguistic-speech/scripts/ipa_validate.py English "naɪt"
→ valid: true, invalid_characters: []
→ exit code 0

$ python3 skills/linguistic-speech/scripts/ipa_validate.py Yoruba "ọkọ"        # FLAGSHIP YORUBA EXAMPLE
→ valid: false, invalid_characters: ["ọ"]
→ warning: "High (acute) / mid (none or macron) / low (grave) — preserve"
→ exit code 1                                                                  ← FALSE NEGATIVE

$ python3 skills/linguistic-speech/scripts/ipa_validate.py Yoruba "ọkọ̀"      # WITH LOW TONE
