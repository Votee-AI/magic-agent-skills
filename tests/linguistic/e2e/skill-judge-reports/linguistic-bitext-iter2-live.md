# Skill Evaluation Report: linguistic-bitext (iteration 2 — LIVE)
...
```
$ python3 skills/linguistic-bitext/scripts/alignment_score.py English Yoruba --target-class 2
...
→ next_step: hand-off to linguistic-tokenize, then linguistic-transfer
→ exit code 0

$ python3 skills/linguistic-bitext/scripts/synthetic_bitext_recipes.py Yoruba --real-pairs 3000 --has-dictionary
