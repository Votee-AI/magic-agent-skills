...
**When NOT to use:** Class 3+ language → standard data ample; cognate bootstrap not needed. Pure typology lookup → `linguistic-scope`.
...
6. **Cognate-based augmentation** is highest-value when (a) target is class 0-1, (b) source is class 3+, (c) URIEL distance < 0.3 (cross-reference `linguistic-scope`).
...
- `linguistic-scope/references/transfer_source_selection.md` for URIEL-based source picking.
- `linguistic-bitext` for cognate-based bitext synthesis.
