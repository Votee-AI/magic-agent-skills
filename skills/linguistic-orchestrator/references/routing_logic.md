...
Decomposition:
- variety enumeration + mutual intelligibility   → linguistic-scope (high confidence)
- dialect-balanced corpus acquisition            → linguistic-corpus (medium confidence)
- variety politics + speaker authority           → linguistic-ethics (high confidence)
...
Routing decision:
  ...
  → linguistic-scope, linguistic-corpus, linguistic-ethics (in that order).
...
- Recommendation: file an issue or propose a new skill (linguistic-<gap-name>)
```
...
```
- [2026-04-23T14:32Z] linguistic-tokenize -- task: fertility audit for Yoruba SentencePiece -- result: fertility 3.4 vs 1.8 baseline; recommended OFA vocab extension
```
