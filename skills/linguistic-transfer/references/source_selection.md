...
Loaded by `linguistic-transfer` Step 5. Wraps `linguistic-scope/scripts/uriel_distance.py` output with adapter-strategy implications.

## Decision flow

```
1. Run linguistic-scope uriel_distance.py with target language.
