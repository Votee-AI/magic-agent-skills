...
for the linguistic-* suite — covers every Joshi 0-5 example language plus
common dialect families). Refresh procedure: see references/canonical_sources.md.

Used by: linguistic-scope (primary), linguistic-corpus (Phase 2),
linguistic-eval (Phase 4).
"""
