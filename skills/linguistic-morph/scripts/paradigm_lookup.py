...
def main() -> int:
            ...
            json.dumps(
                {
                    ...
                    "warning": f"No cached morphology coverage for {rec.iso639_3}; consult linguistic-morph references.",  # noqa: E501  # long anti-pattern string
                },
                indent=2,
            )
        )
    ...
    out = {
        ...
        "next_step": "Hand off to linguistic-tokenize for fertility re-audit; linguistic-syntax for morphology-aware parsing",  # noqa: E501  # long anti-pattern string
    }
