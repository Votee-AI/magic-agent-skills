...
def recommend_config(iso: str, joshi_class: int | None, script: str) -> dict:
    ...
    return {
        ...
        "pre_dedup_steps_required": [
            "1. Unicode NFC normalization (route to linguistic-scripts)",
            "2. TR39 confusable folding for dedup KEY only (route to linguistic-scripts)",
...
def main() -> int:
    ...
    parser.add_argument("--joshi-class", type=int, default=None, help="Joshi 0-5 class (from linguistic-scope)")
