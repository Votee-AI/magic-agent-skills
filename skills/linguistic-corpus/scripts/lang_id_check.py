...
def main() -> int:
            ...
            json.dumps(
                {
                    ...
                    "warning": f"No cached catalog data for {rec.iso639_3}; consult linguistic-corpus references for general guidance.",  # noqa: E501  # long anti-pattern string
                },
                indent=2,
            )
        )
    ...
    out = {
        ...
        "next_step": "route each catalog through linguistic-ethics for license + CARE check before adding to mix",
    }
