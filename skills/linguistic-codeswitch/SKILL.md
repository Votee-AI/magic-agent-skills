...
2. **Per-paragraph LID is the floor** for CS-prevalent corpora. Document-level LID averages over CS and gets it wrong. (Cross-reference `linguistic-corpus/references/language_id.md`.)
...
- `linguistic-corpus/references/language_id.md` for paragraph-level LID.
- `linguistic-tokenize` for CS-aware tokenizer training.
